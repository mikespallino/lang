...
// NumberExprAST - Express class for referencing a variable, like "a".
...
// Call ExprAST - Expression class for function calls.
...
static std::unique_ptr<ExprAST> ParseBinOpRHS(int ExprPrec,
    ...
    while(1) {
        ...
        // If BinOp binds less tighly with RHS than the operator after RHS, let
...
static std::unique_ptr<PrototypeAST> ParsePrototype() {
    if (CurTok != tok_identifier)
        return LogErrorP("Exprected function name in prototype");
...
int main(int argc, char** argv) {
    ...
    TheModule = llvm::make_unique<Module>("my cool git", TheContext);
